...
class ConstraintWidget {
  ...
  SetOscParams() {
    this.last_OscParamPoint = undefined;
  }
  ...
  Initialize(ele, onchanged_callback, on_hover_callback, off_hover_callback) {
    ...
    this.lineGen =
      d3.line()
      .x(function(d) {
        return xScale(d[0] * xAxis.exp_scale);
      })
      .y(function(d) {
        return yScale(d[1] * yAxis.exp_scale);
      });
...
function GetConstraintData() {
  ...
  ConstraintData.AddConstraint(
    "T2K2018_68", "S2Th23", "Dm2_Atm", OscProbConstraintData.T2K2018.S2Th23_Dm2_Atm[68].S2Th23,
    OscProbConstraintData.T2K2018.S2Th23_Dm2_Atm[68].Dm2_Atm,
    "constraint_line constraint_inner T2KConstraint",
    `<div>Expt: ${OscProbConstraintData.T2K2018.Expt}</div><div>Year: ${OscProbConstraintData.T2K2018.Year}</div><div>Ref: ${OscProbConstraintData.T2K2018.Ref}</div>`);
  ConstraintData.AddConstraint(
    "T2K2018_90", "S2Th23", "Dm2_Atm", OscProbConstraintData.T2K2018.S2Th23_Dm2_Atm[90].S2Th23,
    OscProbConstraintData.T2K2018.S2Th23_Dm2_Atm[90].Dm2_Atm,
    "constraint_line constraint_outer T2KConstraint",
    `<div>Expt: ${OscProbConstraintData.T2K2018.Expt}</div><div>Year: ${OscProbConstraintData.T2K2018.Year}</div><div>Ref: ${OscProbConstraintData.T2K2018.Ref}</div>`);

  ConstraintData.AddConstraint(
    "T2K2018_68", "S2Th13", "dcp", OscProbConstraintData.T2K2018.S2Th13_dcp[68].S2Th13,
    OscProbConstraintData.T2K2018.S2Th13_dcp[68].dcp,
    "constraint_line constraint_inner T2KConstraint",
    `<div>Expt: ${OscProbConstraintData.T2K2018.Expt}</div><div>Year: ${OscProbConstraintData.T2K2018.Year}</div><div>Ref: ${OscProbConstraintData.T2K2018.Ref}</div>`);
  ConstraintData.AddConstraint(
    "T2K2018_90", "S2Th13", "dcp", OscProbConstraintData.T2K2018.S2Th13_dcp[90].S2Th13,
    OscProbConstraintData.T2K2018.S2Th13_dcp[90].dcp,
    "constraint_line constraint_outer T2KConstraint",
    `<div>Expt: ${OscProbConstraintData.T2K2018.Expt}</div><div>Year: ${OscProbConstraintData.T2K2018.Year}</div><div>Ref: ${OscProbConstraintData.T2K2018.Ref}</div>`);

  ConstraintData.AddConstraint(
    "NOvA2018_68", "S2Th23", "Dm2_Atm", OscProbConstraintData.NOvA2018.S2Th23_Dm2_Atm[68].S2Th23,
    OscProbConstraintData.NOvA2018.S2Th23_Dm2_Atm[68].Dm2_Atm,
    "constraint_line constraint_inner NOvAConstraint",
    `<div>Expt: ${OscProbConstraintData.NOvA2018.Expt}</div><div>Year: ${OscProbConstraintData.NOvA2018.Year}</div><div>Ref: ${OscProbConstraintData.NOvA2018.Ref}</div>`);
  ConstraintData.AddConstraint(
    "NOvA2018_90", "S2Th23", "Dm2_Atm", OscProbConstraintData.NOvA2018.S2Th23_Dm2_Atm[90].S2Th23,
  ...
  ConstraintData.AddConstraint(
    "NuFIT4_68", "S2Th23", "Dm2_Atm", OscProbConstraintData.NuFIT4.S2Th23_Dm2_Atm[68].S2Th23,
    OscProbConstraintData.NuFIT4.S2Th23_Dm2_Atm[68].Dm2_Atm,
    "constraint_line constraint_inner NuFIT4Constraint",
    `<div>Expt: ${OscProbConstraintData.NuFIT4.Expt}</div><div>Year: ${OscProbConstraintData.NuFIT4.Year}</div><div>Ref: ${OscProbConstraintData.NuFIT4.Ref}</div>`);
  ConstraintData.AddConstraint(
    "NuFIT4_90", "S2Th23", "Dm2_Atm", OscProbConstraintData.NuFIT4.S2Th23_Dm2_Atm[90].S2Th23,
    OscProbConstraintData.NuFIT4.S2Th23_Dm2_Atm[90].Dm2_Atm,
    "constraint_line constraint_outer NuFIT4Constraint",
    `<div>Expt: ${OscProbConstraintData.NuFIT4.Expt}</div><div>Year: ${OscProbConstraintData.NuFIT4.Year}</div><div>Ref: ${OscProbConstraintData.NuFIT4.Ref}</div>`);

  ConstraintData.AddConstraint(
    "NuFIT4_68", "S2Th13", "dcp", OscProbConstraintData.NuFIT4.S2Th13_dcp[68].S2Th13,
    OscProbConstraintData.NuFIT4.S2Th13_dcp[68].dcp,
    "constraint_line constraint_inner NuFIT4Constraint",
    `<div>Expt: ${OscProbConstraintData.NuFIT4.Expt}</div><div>Year: ${OscProbConstraintData.NuFIT4.Year}</div><div>Ref: ${OscProbConstraintData.NuFIT4.Ref}</div>`);
  ConstraintData.AddConstraint(
    "NuFIT4_90", "S2Th13", "dcp", OscProbConstraintData.NuFIT4.S2Th13_dcp[90].S2Th13,
  ...
  ConstraintData.AddConstraint(
    "DB2018_68", "S2Th13", "dcp", OscProbConstraintData.DayaBay2016.S2Th13_dcp["one_sigma"].S2Th13, OscProbConstraintData.DayaBay2016.S2Th13_dcp["one_sigma"].dcp,
    "constraint_line constraint_inner DBConstraint",
    `<div>Expt: ${OscProbConstraintData.DayaBay2016.Expt}</div><div>Year: ${OscProbConstraintData.DayaBay2016.Year}</div><div>Ref: ${OscProbConstraintData.DayaBay2016.Ref}</div>`);
...
function InitializeConstraintWidgets(el, onchanged_callback, on_hover_callback,
  ...
  constraint_plots.push(
    new ConstraintWidget(constraint_data["S2Th13_dcp"], ax_S2Th13, ax_dcp_mpi_pi));

  constraint_plots.push(
    new ConstraintWidget(constraint_data["dcp_S2Th23"], ax_dcp_0_2pi, ax_S2Th23));
